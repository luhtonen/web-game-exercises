...
$.playground().registerCallback(function() {
	...
	$("#background3").x(($("#background3").x() - farParallaxSpeed - PLAYGROUND_WIDTH) % (-2 * PLAYGROUND_WIDTH) + PLAYGROUND_WIDTH);
	$("#background4").x(($("#background4").x() - farParallaxSpeed - PLAYGROUND_WIDTH) % (-2 * PLAYGROUND_WIDTH) + PLAYGROUND_WIDTH);
}, REFRESH_RATE);
